...
def evaluate_model(
    model, test_series: List, test_static_cov: List, input_size: int, output_size: int
) -> Tuple:
...
def evaluate_single_model(
    ...
    predictions_extended = model.predict(
    ...
    return {
        ...
        "predictions_standard": predictions_standard[0]
        if predictions_standard
        else None,
        "predictions_extended": predictions_extended[0]
        if predictions_extended
        else None,
